          ...
          <div class="col-12">
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <a href="news.html" class="img-bg d-flex align-items-end" style="background-image: url('/resources/assets/img/memphis.jpg');">
                    <div class="img-bg-inner">
                    </div>
                  </a>
                </div>
                ...
                <div class="swiper-slide">
                  <a href="news.html" class="img-bg d-flex align-items-end" style="background-image: url('/resources/assets/img/shestars.jpg');">
                    <div class="img-bg-inner">
                    </div>
                  </a>
                </div>
                ...
                <div class="swiper-slide">
                  <a href="news.html" class="img-bg d-flex align-items-end" style="background-image: url('/resources/assets/img/benher.jpg');">
                    <div class="img-bg-inner">
                    </div>
                  </a>
                </div>
    ...
    <!-- ======= Culture Category Section ======= -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header d-flex justify-content-between align-items-center mb-5">
          <h2>News</h2>
          <div><a href="news.jsp" class="more">See All News</a></div>
        </div>
